...
setup(
    ...
    # project.
    author='Jérémie Chabloz',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='jeremie.chabloz@a3.epfl.ch',  # Optional
    ...
    #
    packages=find_packages(where='ngspicex'),  # Required
